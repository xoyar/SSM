...
--%>
    ...
    $(document).ready(function(){
        ...
        var menuId = $("#id").val();
        $.get("/menu/getParentMenuTreeData?menuId="+menuId,
            function(zNodes){
                //初始化数结构
    ...
    $(function() {
        ...
        alert(jsonObj);
        loading('正在提交，请稍等...');
        $.ajax({//编辑或添加页面后，alert出获取数据的json格式
            type:'post',//请求方式
            url:'/menu/saveMenu',
            ...
            success:function(data){//与服务器交互成功调用的回调函数
                ...
                alert(data.result);
                //history.go(-1);
                document.location.href="/menu/menuList"//刷新页面
            }
        });
    },
    ...
    <br />
    <form id="menuEditForm" class="form-horizontal" action="/menu/saveMenu" method="post">
